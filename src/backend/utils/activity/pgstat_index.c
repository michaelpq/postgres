 ...
 *
 * This file contains the implementation of index statistics. It is kept
 * separate from pgstat_relation.c to enforce the separation between
 * table and index statistics kinds.
 *
