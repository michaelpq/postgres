...
-- the following exceptions: pg_largeobject and pg_largeobject_metadata.
-- Large object catalogs and toast tables are mutually exclusive and
-- large object data is handled as user data by pg_upgrade, which would
-- cause failures.
